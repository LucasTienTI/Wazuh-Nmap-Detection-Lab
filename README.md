...
Análise de Fluxo: Identificação precisa do IP de origem do atacante e das portas visadas.

📂 Arquivos do Repositório
ossec-windows-agent.conf: Arquivo de configuração customizado para o agente Windows.
